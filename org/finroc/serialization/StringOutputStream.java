...
@HAppend( {
    ...
    "inline StringOutputStream& operator<< (StringOutputStream& os, int64_t t) { os.wrapped << t; return os; }",
    ...
    "inline StringOutputStream& operator<< (StringOutputStream& os, uint64_t t) { os.wrapped << t; return os; }",
