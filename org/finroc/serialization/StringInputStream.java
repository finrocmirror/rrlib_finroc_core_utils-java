...
@HAppend( {
    ...
    "inline StringInputStream& operator>> (StringInputStream& is, int64_t& t) { is.wrapped  >> t; return is;  }",
    ...
    "inline StringInputStream& operator>> (StringInputStream& is, uint64_t& t) { is.wrapped  >> t; return is;  }",
