...
public class XMLNode {
     ...
     *
     * @exception XML2WrapperException is thrown if the given libxml2 element is not a node
     *
     ...
     *
     * @exception XML2WrapperException is thrown if the node already contains text content
     *
     ...
     *
     * @exception XML2WrapperException is thrown if the given node is not a child node
     *
     ...
     * a String reference.
     *
     * @exception XML2WrapperException is thrown if the node does not contain plain text content
     *
     * @return A reference to the plain text content
     */
    public String getTextContent() throws XML2WrapperException {
        NodeList nl = node.getChildNodes();
        for (int i = 0; i < nl.getLength(); i++) {
            Node n = nl.item(i);
        ...
        throw new XML2WrapperException("This node does not have any text content!");
    }

    /**
     * Set the plain text content of this node
     *
     * @exception XML2WrapperException is thrown if the node already has structural children
     *
    ...
    public void setTextContent(String content) throws XML2WrapperException {
        ...
        for (int i = 0; i < nl.getLength(); i++) {
            Node n = nl.item(i);
            if (n.getNodeType() == Node.ELEMENT_NODE) {
                throw new XML2WrapperException("Tried to set text content in a node that already has structural children!");
            }
        }
        removeTextContent();
     ...
     *
     * @exception XML2WrapperException is thrown if the requested attribute is not available
     *
     * @param name   The name of the attribute
     *
     * @return The attribute as string
     */
    public String getStringAttribute(String name) throws XML2WrapperException {
        String s = node.getAttribute(name);
        if (s == null || s.length() == 0) {
            throw new XML2WrapperException("Requested attribute `" + name + "' does not exist in this node!");
        }
        return s;
    }
     ...
     *
     * @exception XML2WrapperException is thrown if the requested attribute's value is available or not a number
     *
     * @param name   The name of the attribute
     ...
     */
    public int getIntAttribute(String name) throws XML2WrapperException {
     ...
     * @return The attribute as int
     */
    public int getIntAttribute(String name, int base) throws XML2WrapperException {
     ...
     */
    public long getLongLongIntAttribute(String name) throws XML2WrapperException {
     ...
     * @return The attribute as long long int
     */
    public long getLongLongIntAttribute(String name, int base) throws XML2WrapperException {
     ...
     */
    public float getFloatAttribute(String name) throws XML2WrapperException {
     ...
     */
    public double getDoubleAttribute(String name) throws XML2WrapperException {
     ...
     * as bool.
     *
     * @exception XML2WrapperException is thrown if the requested attribute's value is available or not true/false
     *
     * @param name   The name of the attribute
     *
     * @return Whether the attribute's value was "true" or "false"
     */
    public boolean getBoolAttribute(String name) throws XML2WrapperException {
        ...
        throw new XML2WrapperException("Invalid boolean value: " + s);
    }
     ...
     *
     * @exception XML2WrapperException is thrown if the requested attribute does not exist and should not be created
     *
     * @param name     The name of the attribute
