...
public class CharArrayWrapper {
    ...
    private static final CharArrayWrapper EMPTY = new CharArrayWrapper(0);

//  /**
//   * @param backend backend
//   * @param size size of array... may be smaller than backend capacity
//   */
//  public CharArrayWrapper(char[] backend, int size) {
...
//  }
     ...
     */
    public static CharArrayWrapper getEmpty() {
        return EMPTY;
    }
     ...
     * @param size size of array... may be smaller than backend capacity
     */
    public CharArrayWrapper(int size) {
        this.size = size;
        this.backend = new char[size];
        // in cpp mit 0 füllen
    }
...
//  }
     ...
     */
    public void copyAllFrom(CharArrayWrapper from) {
